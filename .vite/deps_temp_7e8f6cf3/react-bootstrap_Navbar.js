...
var divWithClassName_default = (className) => React19.forwardRef((p, ref) => (0, import_jsx_runtime18.jsx)("div", {
  ...p,
  ref,
...
function DialogTransition(props) {
  return (0, import_jsx_runtime20.jsx)(OffcanvasToggling_default, {
    ...props
  });
}
function BackdropTransition(props) {
  return (0, import_jsx_runtime20.jsx)(Fade_default, {
    ...props
  });
}
var Offcanvas = React21.forwardRef(({
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime20.jsx)("div", {
    ...backdropProps,
    className: (0, import_classnames11.default)(`${bsPrefix}-backdrop`, backdropClassName)
  }), [backdropClassName, bsPrefix]);
  const renderDialog = (dialogProps) => (0, import_jsx_runtime20.jsx)("div", {
    ...dialogProps,
    ...props,
  ...
  return (0, import_jsx_runtime22.jsxs)(import_jsx_runtime21.Fragment, {
    children: [!showOffcanvas && (responsive || renderStaticNode) && renderDialog({}), (0, import_jsx_runtime20.jsx)(ModalContext_default.Provider, {
      value: modalContext,
      children: (0, import_jsx_runtime20.jsx)(Modal_default, {
        show: showOffcanvas,
        ref,
        backdrop,
        container,
...
var NavbarOffcanvas = React22.forwardRef((props, ref) => {
  const context = (0, import_react20.useContext)(NavbarContext_default);
  return (0, import_jsx_runtime23.jsx)(Offcanvas_default, {
    ref,
...
var Navbar = React24.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime25.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime25.jsx)(SelectableContext_default.Provider, {
      value: handleCollapse,
      children: (0, import_jsx_runtime25.jsx)(Component, {
        ref,
        ...controlledProps,
